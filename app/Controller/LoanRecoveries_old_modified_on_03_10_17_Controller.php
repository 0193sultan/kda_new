 ...
 */
class LoanRecoveries_old_modified_on_03_10_17_Controller extends AppController {
    ...
    public function admin_index() {
       ...
       // $this->LoanRecovery->recursive = 3;
        //$this->paginate = array('contain' => array('Loan' => array('conditions' => array('Loan.id' => 6))) ,'order' => array('LoanRecovery.id' => 'DESC'), 'group' => array('LoanRecovery.employee_loan_id'));
