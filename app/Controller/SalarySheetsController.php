                        ...
                        if ($checkFlag == 1 && $loanval['status'] == 1) {
                            ...
                            if ($loanval['current_due'] != 0) {
                                if ($loanval['current_due'] >= $loanval['installment_amount']) {
                                    ...
                                    $loanRecoverydata['LoanRecovery']['recovery_current_due'] = $loanval['installment_amount'];
                                    ...
                                    $loanRecoverydata['LoanRecovery']['recovery_loan_amount'] = $loanval['current_due'];
                                    $loanRecoverydata['LoanRecovery']['recovery_current_due'] = $loanval['current_due'];
                                    $loanRecoverydata['LoanRecovery']['recovery_interest_amount_due'] = 0;
                                    $loanRecoverydata['LoanRecovery']['employee_loan_id'] = $emp_loans[$key][$j]['EmployeeLoan']['id'];
                                    $loanRecoverydata['LoanRecovery']['created_at'] = $this->current_datetime();
                                    $loanRecoverydata[] = $loanRecoverydata;
                                    $this->LoanRecovery->saveAll($loanRecoverydata);
                                ...
                                if ($loanval['interest_amount_due'] != 0) {
                                    if ($loanval['interest_amount_due'] >= $loanval['installment_amount']) {
                                        ...
                                        $loanRecoverydata['LoanRecovery']['recovery_loan_amount'] = $loanval['installment_amount'];
                                        $loanRecoverydata['LoanRecovery']['recovery_interest_amount_due'] = $loanval['installment_amount'];
                                        $loanRecoverydata['LoanRecovery']['employee_loan_id'] = $emp_loans[$key][$j]['EmployeeLoan']['id'];
                                        $loanRecoverydata['LoanRecovery']['created_at'] = $this->current_datetime();
                                        $loanRecoverydata[] = $loanRecoverydata;
                                        $this->LoanRecovery->saveAll($loanRecoverydata);
                                        ...
                                        $loanRecoverydata['LoanRecovery']['recovery_interest_amount_due'] = $loanval['interest_amount_due'];
                                        $loanRecoverydata['LoanRecovery']['employee_loan_id'] = $emp_loans[$key][$j]['EmployeeLoan']['id'];
                                        $loanRecoverydata['LoanRecovery']['created_at'] = $this->current_datetime();
                                        $loanRecoverydata[] = $loanRecoverydata;
                                        $this->LoanRecovery->saveAll($loanRecoverydata);
                            ...
                            if ($loanval['loan_type_id'] == 8):
                                if ($loanval['current_due'] != 0) {
                                    if ($loanval['current_due'] >= $loanval['installment_amount']) {
                                        ...
                                        $gpf['GpfSubscription']['total_subscription_balance'] = $gpf['GpfSubscription']['total_subscription_balance'] + $loanval['current_due'];
                                        $gpf['GpfSubscription']['loan_interest_recovery'] = 0;
