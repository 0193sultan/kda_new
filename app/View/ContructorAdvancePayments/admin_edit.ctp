    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Admin Edit Contructor Advance Payment'); ?></h3>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <?php echo $this->Form->input('contructor_project_name_id', array('label' => 'Project Name', 'id' => 'contructor_project_name_id', 'class' => 'form-control', 'empty' => array('' => '------ Please Select -------'))); ?>
                </div>
                <div class="form-group">
                    <?php echo $this->Form->input('contructor_name_id', array('label' => 'Contructor Name', 'id' => 'contructor_name_id', 'class' => 'form-control', 'empty' => array('' => '------ Please Select -------'))); ?>
                </div>

                <?php echo $this->Form->input('workOrderId', array('type' => 'hidden', 'id' => 'workOrderId', 'class' => 'form-control', 'label' => 'Work Order Id', 'value' => !empty($workOrderId) ? $workOrderId : '')); ?>
                <div class="form-group">
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (result.length != 0) {
                        ...
                        for (var x in result) {
                            if (workOrderId == result[x].WorkOrder.id) {
                                options += '<option value=' + '"' + result[x].WorkOrder.id + '" selected>' + result[x].WorkOrder.work_order_no + '</option>'
                            } else {
