    ...
    <div class="col-xs-12">		
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-eye-open"></i> <?php  echo __('Basic'); ?></h3>
				<div class="box-tools pull-right">
	                <?php echo $this->Html->link(__('<i class="glyphicon glyphicon-th-large"></i> Basic List'), array('action' => 'index'), array('class' => 'btn btn-primary', 'escape' => false)); ?>
				</div>
			</div>			
			<div class="box-body">
		...
		<td>
			<?php echo h($basic['Basic']['id']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Name'); ?></strong></td>
		<td>
			<?php echo h($basic['Basic']['name']); ?>
			&nbsp;
		</td>
</tr>					</tbody>
				</table>
		...
		<th class="text-center"><?php echo __('Contact No'); ?></th>
							...
							<tbody>
									<?php
										$i = 0;
										foreach ($basic['Employee'] as $employee): ?>
		<tr>
