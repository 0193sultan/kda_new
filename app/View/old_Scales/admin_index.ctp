    ...
    <div class="col-xs-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-th-large"></i> <?php echo __('Scales'); ?></h3>
				<div class="box-tools pull-right">
					<?php if($this->App->menu_permission('scales','admin_add')){ echo $this->Html->link(__('<i class="glyphicon glyphicon-plus"></i> New Scale'), array('action' => 'add'), array('class' => 'btn btn-primary', 'escape' => false)); } ?>
				</div>
			</div>	
			<div class="box-body">
                <table id="Scales" class="table table-bordered table-striped">
					...
					<tr>
						<td class="text-center"><?php echo h($scale['Scale']['id']); ?></td>
						<td class="text-center"><?php echo h($scale['Scale']['name']); ?></td>
						<td class="text-center">
							<?php if($this->App->menu_permission('scales','admin_view')){ echo $this->Html->link(__('<i class="glyphicon glyphicon-eye-open"></i>'), array('action' => 'view', $scale['Scale']['id']), array('class' => 'btn btn-primary btn-xs', 'escape' => false, 'data-toggle'=>'tooltip', 'title' => 'view')); } ?>
