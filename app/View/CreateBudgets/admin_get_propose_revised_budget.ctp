...
<div class="row">
    <div class="col-md-12">
        <div class="box-header">
            <h2 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Propose Revised Budget'); ?></h2>
        </div>
        <div class="box-body">
                ...
                <tbody>
                    <?php foreach ($budget_head_list_info as $key => $value): ?>
                        <tr>
                            ...
                            <td><?= !empty($value['PrevApprovedBudget']['budget_amount'])?$value['PrevApprovedBudget']['budget_amount']:''; ?></td>
