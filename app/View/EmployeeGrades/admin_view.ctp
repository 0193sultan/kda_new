    ...
    <div class="col-xs-12">		
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-eye-open"></i> <?php  echo __('Employee Grade'); ?></h3>
				<div class="box-tools pull-right">
	                <?php echo $this->Html->link(__('<i class="glyphicon glyphicon-th-large"></i> Employee Grade List'), array('action' => 'index'), array('class' => 'btn btn-primary', 'escape' => false)); ?>
				</div>
			</div>			
			<div class="box-body">
		...
		<td>
			<?php echo h($employeeGrade['EmployeeGrade']['id']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Name'); ?></strong></td>
		<td>
			<?php echo h($employeeGrade['EmployeeGrade']['name']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Grade Declare Year'); ?></strong></td>
		<td>
			<?php echo h($employeeGrade['EmployeeGrade']['grade_declare_year']); ?>
			&nbsp;
		</td>
</tr>					</tbody>
				</table>
			...
			<div class="box box-primary">
				...
				<?php if (!empty($employeeGrade['Employee'])): ?>
		...
		<th class="text-center"><?php echo __('Child Number'); ?></th>
		<th class="text-center"><?php echo __('Contact No'); ?></th>
							...
							<tbody>
									<?php
										$i = 0;
										foreach ($employeeGrade['Employee'] as $employee): ?>
		<tr>
			...
			<td class="text-center"><?php echo $employee['department_id']; ?></td>
			...
			<td class="text-center"><?php echo $employee['child_number']; ?></td>
