    ...
    <div class="col-xs-12">		
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-eye-open"></i> <?php  echo __('Religion'); ?></h3>
				<div class="box-tools pull-right">
	                <?php echo $this->Html->link(__('<i class="glyphicon glyphicon-th-large"></i> Religion List'), array('action' => 'index'), array('class' => 'btn btn-primary', 'escape' => false)); ?>
				</div>
			</div>			
			<div class="box-body">
		...
		<td>
			...
			<div class="box box-primary">
				...
				<?php if (!empty($religion['Employee'])): ?>
		...
		<th class="text-center"><?php echo __('Contact No'); ?></th>
							...
							<tbody>
									<?php
										$i = 0;
										foreach ($religion['Employee'] as $employee): ?>
		<tr>
