            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    foreach ($Employee as $key => $employee) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $employee['Employee']['employee_name_bengali'] ?></td>
                            <td><?php echo $employee['Department']['name'] ?></td>
                            <td><?php echo $employee['Designation']['name'] ?></td>
                            <td class="bonus_amount"><?php
                                echo number_format($employee['Scale']['grade_basic'], 2);
                                $sum = $i + $employee['Scale']['grade_basic'];
                                $i = $sum;
                                ?></td>
                            <td><?php echo $employee['Employee']['employeeID'] ?>
                            </td>
                            <td><?php echo $employee['Employee']['account_number'] ?></td>
                        </tr>
                        <?php
                    }
                    ?>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td><strong class="total_bonus_amount"><?= number_format($sum,2) ?></strong></td>
                    </tr>
                </tfoot>
            </table>
