    ...
    <div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><i class="glyphicon glyphicon-edit"></i>  <?php echo __('Admin Edit Warter Supply Setting'); ?></h3>
			...
			<div class="box-body">		
			<?php echo $this->Form->create('WarterSupplySetting', array('role' => 'form')); ?>
					...
					<div class="form-group">
						<?php echo $this->Form->input('grade_start', array('class' => 'form-control')); ?>
					</div>
					<div class="form-group">
						<?php echo $this->Form->input('grade_end', array('class' => 'form-control')); ?>
					</div>
					<div class="form-group">
						<?php echo $this->Form->input('location_id', array('class' => 'form-control')); ?>
					</div>
					<div class="form-group">
						<?php echo $this->Form->input('water_bill', array('class' => 'form-control')); ?>
					</div>
