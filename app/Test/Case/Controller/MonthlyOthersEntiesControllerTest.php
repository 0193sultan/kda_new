<?php
App::uses('MonthlyOthersEntiesController', 'Controller');

/**
 * MonthlyOthersEntiesController Test Case
 *
 */
class MonthlyOthersEntiesControllerTest extends ControllerTestCase {
