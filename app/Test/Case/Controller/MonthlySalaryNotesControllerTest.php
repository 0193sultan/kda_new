<?php
App::uses('MonthlySalaryNotesController', 'Controller');

/**
 * MonthlySalaryNotesController Test Case
 *
 */
class MonthlySalaryNotesControllerTest extends ControllerTestCase {
