<?php
App::uses('FiscalYearSettingsController', 'Controller');

/**
 * FiscalYearSettingsController Test Case
 *
 */
class FiscalYearSettingsControllerTest extends ControllerTestCase {
