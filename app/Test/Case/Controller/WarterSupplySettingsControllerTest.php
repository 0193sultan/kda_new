<?php
App::uses('WarterSupplySettingsController', 'Controller');

/**
 * WarterSupplySettingsController Test Case
 *
 */
class WarterSupplySettingsControllerTest extends ControllerTestCase {
