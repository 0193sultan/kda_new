<?php
App::uses('EmployeeHouseRentSettingsController', 'Controller');

/**
 * EmployeeHouseRentSettingsController Test Case
 *
 */
class EmployeeHouseRentSettingsControllerTest extends ControllerTestCase {
